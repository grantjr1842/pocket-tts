...
pub mod utils {
    use super::math::{INF, NEG_INF, NAN};
...
pub use math::{E, PI, TAU, INF, NEG_INF, NAN};
pub use dtype::{
    INT8_MAX, INT8_MIN, INT16_MAX, INT16_MIN, 
    INT32_MAX, INT32_MIN, INT64_MAX, INT64_MIN,
    UINT8_MAX, UINT16_MAX, UINT32_MAX, UINT64_MAX
};
pub use float::{
    MIN_POSITIVE, EPSILON, MAX, MIN, EPSILON_F32
};
pub use array::{MAX_DIMS, MAX_ELEMENTS, DEFAULT_ALIGNMENT};